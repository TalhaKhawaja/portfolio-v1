module.exports = {
    ...
    sections: [
        {
            about: {
                salutation: 'Hello!',
                intro: 'I am Talha Khawaja',
                info: 'I am a Software Engineer based in Long Island, NY',
                additionalInfo: 'I have worked on frontend and backend development in my software engineering career'
            },
            experience: [{
                startDate: 'Feburary 2017',
    ...
    socialMedia: [
        {
            name: 'LinkedIn',
            url: 'https://www.linkedin.com/in/talha-khawaja-21000151/'
        }, {
            name: 'GitHub',
